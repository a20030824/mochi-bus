...
export function renderSetupPage(cities: ReadonlyArray<readonly [string, string]>): string {
  ...
  </main>`, setupScript(), siteSearchDescription, true)
}
