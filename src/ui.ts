...
export function renderETAPage(view: ETAView): string {
  ...
  </script>`, description: pageDescription, canonical: canonicalUrl(requestUrl) })
}
...
const credentialStyles = `.credential-field{display:grid;gap:6px}.credential-field>label{color:#716a60;font-size:13px;font-weight:750}.credential-field input[aria-invalid="true"]{border-color:#9b4b35}.tdx-remember{display:flex;align-items:flex-start;gap:10px;padding:12px;border:1px solid #ded6c9;border-radius:12px;cursor:pointer}.tdx-remember input{flex:none;width:18px;height:18px;margin:2px 0 0;padding:0;border-radius:4px;background:transparent;accent-color:#df7357}.tdx-remember span{display:grid;gap:3px}.tdx-remember strong{font-size:14px}.tdx-remember small{color:#777066;font-size:13px;line-height:1.5}.form-message.form-message-error{color:#9b4b35;font-weight:750}@media(prefers-color-scheme:dark){.credential-field>label,.tdx-remember small{color:#aaa197}.tdx-remember{border-color:#4d473e}.credential-field input[aria-invalid="true"]{border-color:#f09b80}.form-message.form-message-error{color:#f09b80}}`
