// Leaflet 圖層畫在 canvas/SVG 上,吃不到 CSS custom property,深色模式的
// 路線與站點幾何色只能在 JS 端切換。載入時判定一次:圖層不會跟著系統主題
// 即時重繪,主題切換以整頁重新整理為準,和 tile filter 的行為一致。
export const prefersDarkMap = typeof matchMedia === 'function'
...
// 站點與端點標記的填色:深色版與 CSS 的 --green / --accent 深色值一致。
