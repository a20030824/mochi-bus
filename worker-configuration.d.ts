/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=CloudflareBindings` (hash: f2f334fe7333652ba0df0778d0f9a0d0)
// Runtime types generated with workerd@1.20260708.1 2026-07-03 
interface __BaseEnv_CloudflareBindings {
	TRANSIT_SHAPES: R2Bucket;
	TRANSIT_DB: D1Database;
	API_STANDARD_RATE_LIMITER: RateLimit;
	API_EXPENSIVE_RATE_LIMITER: RateLimit;
	TDX_VERIFY_RATE_LIMITER: RateLimit;
